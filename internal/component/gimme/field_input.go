...
func (i *Input) Value(value *string) *Input {
	return i.Accessor(huh.NewPointerAccessor(value))
}

// Accessor sets the accessor of the input field.
func (i *Input) Accessor(accessor huh.Accessor[string]) *Input {
	i.accessor = accessor
...
func (i *Input) activeStyles() *huh.FieldStyles {
	theme := i.theme
	if theme == nil {
...
func (i *Input) WithKeyMap(k *huh.KeyMap) Field {
	i.keymap = k.Input
...
func (i *Input) WithTheme(theme huh.Theme) Field {
	if i.theme != nil {
		return i
	}
	i.theme = theme
